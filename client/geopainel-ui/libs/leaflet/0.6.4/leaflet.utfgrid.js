...
L.UtfGrid = L.Class.extend({
	...
	_objectForEvent: function (e) {
		...
		// console.log("key", key);
		// data = data['firefox_db1_municipios'];
		data = data[key];
		if (!data) {
			return { latlng: e.latlng, data: null };
		}
		...
		// console.log("data.grid", data.grid.substring(0, 30));
		...
		if (!data.data.hasOwnProperty(key)) {
			...
			// console.log("charCodeAt", data.grid[gridY].charCodeAt(gridX));
			// console.log("key", key, "idx", idx, "data", data);
			result = null;
		}
